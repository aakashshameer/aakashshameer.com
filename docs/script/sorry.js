...
noButton.addEventListener('mouseover', (event) => {
    ...
    message.innerHTML = 'Pls pls';  // Change the message content
...
yesButton.addEventListener('click', () => {
    ...
    message.style.display = 'block';  // Make the message visible
    message.innerHTML = 'I am sorry okay';  // Change the message content

    setTimeout(() => {
       // message.style.display = 'none';  // Hide the message
       message.innerHTML = 'Pls call me when you can';  // Change the message content
